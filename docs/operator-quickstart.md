# Operator Quickstart — cloud-itonami-isic-900

Shortest path from clone to a verified local dry-run for **ISIC 900** (`cloud-itonami-isic-900`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-900.git
cd cloud-itonami-isic-900
```
...
- Likely source path: `venueadminops.governor.cljc`
